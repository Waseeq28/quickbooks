...
export default async function ErrorPage() {
  ...
  const message =
    store.get("app_err_message")?.value || "An unexpected error occurred.";
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background p-6">
      <div className="w-full max-w-md rounded-xl border border-border/50 bg-card/60 shadow-xl p-6 text-center">
        ...
        <div className="flex items-center justify-center gap-3">
          <Link
            href={backHref}
            className="min-w-[160px] inline-flex items-center justify-center rounded-lg bg-primary text-white px-4 py-2 text-sm font-medium hover:bg-primary/90"
          >
